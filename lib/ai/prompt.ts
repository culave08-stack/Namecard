...
companyDescription (회사 소개) — Google Search로 회사 정보를 찾았다면 짧게 요약:
- **한국어 1-2문장**으로 회사가 무슨 사업을 하는지 간략히 요약 (최대 120자).
- 회사 공식 사이트·뉴스 등 신뢰할 만한 출처 1-2개 참고. 검색 결과가 없거나 회사가 너무 무명이면 null.
- 마케팅 문구나 자랑 톤은 피하고, 사실 위주로 담백하게 ("교육용 SaaS 솔루션을 제공하는 한국 스타트업", "베트남 호치민 소재 통신·인터넷 서비스 사업자" 같은 톤).
- 명함에 적힌 슬로건/태그라인은 description으로 쓰지 마세요. 검색으로 확인 가능한 객관적 사실만.
...
좋은 예시 (한+영 이름 분리, 대기업, 연락처 풀세트):
{
  ...
  "industry": "제조",
  "companyType": "대기업",
  "companyDescription": "한국의 종합 전자·반도체 제조 대기업.",
